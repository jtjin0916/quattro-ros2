...
def generate_launch_description():
    ...
    return LaunchDescription([
        Node(package='quattro', executable='keyboard_teleop', name='quattro_keyboard', output='screen'),
        Node(package='quattro', executable='quattro_sm', name='quattro_sm', output='screen', parameters=[{'frequency': 100.0}]),
        Node(
